...
export default function Section() {
  return (
    <>
      ...
      <Features style='md:flex md:flex-row-reverse' alt='Scheduling' img='images/mockup.png' title='Schedule Meetings Seamlessly' content='Experience the freedom from scheduling headaches as Meetlink automates the entire process, enabling you to focus on what truly matters - productive and meaningful face-to-face interactions. Seamlessly connect with colleagues, clients, and partners, and make every meeting count.' />
      <Features style='md:flex md:flex-row' alt='Integate Access' img='images/admin-dashboard-mockup.png' title='Integrate Your Access Control System' content='Effortlessly synchronize visitor and employee data with your access control system, enabling seamless integration. Employ the convenience of unique QR codes or Access Codes to grant access precisely when needed. Securities or staffs can stay informed in real-time about the presence of individuals within the premises. Bid farewell to any concerns about unauthorized access. Indeed, as the famous saying goes, "Peter has left the building."' />
      <Features style='md:flex md:flex-row-reverse' img='images/security-mockup.png' alt='Organisation Safety' title='Secure the Workplace.' content='MeetLink’s pre-arrival check-in requirements ensure organisation security and compliance. Elevate your organization’s physical security and gain greater control over unauthorized entries with our powerful Meetlink portal. Enjoy real-time visitor insights, streamline security processes, and ensure enhanced safety for everyone.' />
    </>
  )
}
