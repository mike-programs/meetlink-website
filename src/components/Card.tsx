        ...
        <>
            <div className='mx-4 bg-primaryColor text-white p-16 text-center md:mx-28 md:my-28'>
                <div className='font-bold'>
                    ...
                    <p className='leading-[3rem] text-xl mt-9'>Configure Proxyclick to pre-screen visitors, advance guest credentials, and let people into the workspace based on predetermined conditions.</p>
                </div>
